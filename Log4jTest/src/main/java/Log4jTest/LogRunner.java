    ...
    public void run() {
        try {
            while (true) {
                ...
                eventMap.put("日志产生时间",logDateTime);
                eventMap.put("日志级别",event.getLevel());
                ...
                eventMap.put("异常信息",event.getThrowableInformation());
                eventMap.put("Message信息",event.getMessage());


                System.out.println(eventMap.toString());


//                System.out.println("触发日志事件的线程名: "+event.getThreadName());
//                System.out.println("日志发生位置信息代码行号: "+event.getLocationInformation().getLineNumber());
//                System.out.println("日志发生位置信息文件名: "+event.getLocationInformation().getFileName());
//                System.out.println("日志发生位置信息所在类名: "+event.getLocationInformation().getClassName());
//                System.out.println("日志发生位置信息所在函数名: "+event.getLocationInformation().getMethodName());
//                System.out.println("异常信息: "+event.getThrowableInformation());
//
//                // 时间戳转换
//                long lSysTime1 = event.getStartTime() / 1000;
//                SimpleDateFormat sdf= new SimpleDateFormat("yyyy/MM/dd HH:mm:ss");
//                Date date = new Date(lSysTime1 * 1000);
//                String sDateTime = sdf.format(date);
//
//                System.out.println("日志产生时间: "+sDateTime);
//                System.out.println("日志级别: "+event.getLevel());
//                System.out.println("Message信息: "+event.getMessage());
//
//
//                System.out.println("                                ");
//                System.out.println("--------------------------------");
