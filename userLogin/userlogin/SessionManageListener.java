...
public class SessionManageListener implements HttpSessionListener {
    ...
    public void sessionCreated(HttpSessionEvent event) {
        ...
        logger.debug("web容器session对象被创建，sid: " + session.getId());
    }
    ...
    public void sessionDestroyed(HttpSessionEvent event) {
        ...
        logger.debug("web容器有session对象被销毁: " + session.getId());
    ...
    public static Map<String, String> getUserSessionMap(){
        ...
        while (iterator.hasNext()){
            ...
            if (user != null){
                usersSessionMap.put(user.getUserLoginName(),sessionId);
            }
        }
     ...
     * @return
     */
    public synchronized static boolean checkIfHasLogin(User userIsLogin){
        Iterator<String> iterator = getSessionMapKeySetIt();
        ...
        while (iterator.hasNext()){
            ...
            if (userIsCheck.getUserLoginName().equals(userIsLogin.getUserLoginName())){
                hasLogin = true;
                break;
            }
        }
